/**
 * Vidhi design tokens — the *only* place type sizes, spacing, and color
 ...
 *   2. Selective accent. Saffron only where a *decision* lives —
...
export const t = {
  font: {
    /** Source Serif 4 — for matter titles, headings inside content (briefs,
     *  drafts), the brand. Anything that should feel "legal-document-y". */
    serif:
  ...
  size: {
    h1: '32px',     // page title (matter name on a matter detail page)
    h2: '20px',     // section heading (Sources, Documents, Today's matters)
    body: '15px',   // normal reading text — case briefs, answer paragraphs
   ...
   *   - accent: saffron (Indian, distinctive). Used ONLY for decisions.
   *   - info / warn / danger: status only.
   *   These map to the existing CSS variables on :root, so the legacy
